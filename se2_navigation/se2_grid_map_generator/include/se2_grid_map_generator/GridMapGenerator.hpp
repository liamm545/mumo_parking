...
class GridMapGenerator {
 ...
 protected:
  ...
  bool saveMapService(se2_grid_map_generator_msgs::SaveMap::Request& req, se2_grid_map_generator_msgs::SaveMap::Response& res);

  void setPolygonInMap(const std::string layerName, const grid_map::Polygon polygon, const double value);
  // void setPolygonInMap(const std::string layerName, const grid_map::Polygon& polygon, const double value);

  void setCircleInMap(const std::string layerName, const grid_map::Position center, const double radius, const double value);
